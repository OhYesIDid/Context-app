    ...
    <div className="min-h-screen">
      ...
      <article className="max-w-2xl mx-auto px-6 py-16 prose prose-zinc">
        ...
        <section className="mb-8">
          ...
          <p className="text-zinc-600 leading-relaxed">
            ConTxt stores your app preferences (tone, monitored apps, saved places) and a short history
            of reply edits locally on your device to personalise future suggestions. This data never
            leaves your device unless you enable optional cloud sync.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-zinc-600 leading-relaxed">
            Message content, location data, and calendar events are processed in real time to generate
            a reply and are never stored on our servers. Reply suggestions are ephemeral — once
            dismissed they are gone.
          </p>
        </section>
